...
Looks like you have installed `tc` and understood the [concepts](/introduction/concepts) and [features](/introduction/features) in abstract. They will become clearer to you as you start playing with tc.
Let's jump in and try a `hello world` topology. We'd like to define a HTTP GET route backed by a serverless function that returns a message. Common usecase right ?
...
This of course is a very simplistic view of tc. You may want to say more than hello to the world. Give this [Example](/examples/rest-api) a try!
