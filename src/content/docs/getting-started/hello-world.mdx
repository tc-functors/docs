...
Let's jump in and try a `hello world` topology. We'd like to define a HTTP GET route backend by a serverless function that returns a message. Common usecase right ?
