...
|---------------------------------------------------------------------------------|--------------------------------------------------------------------|
| [0.9.140](https://github.com/tc-functors/tc/releases/download/0.9.140/tc-x86_64-linux) | [0.9.140](https://github.com/tc-functors/tc/releases/download/0.9.140/tc-aarch64-macos)
