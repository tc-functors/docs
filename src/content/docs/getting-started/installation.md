...
|---------------------------------------------------------------------------------|--------------------------------------------------------------------|
| [0.9.165](https://github.com/tc-functors/tc/releases/download/0.9.165/tc-x86_64-linux) | [0.9.165](https://github.com/tc-functors/tc/releases/download/0.9.165/tc-aarch64-macos)
