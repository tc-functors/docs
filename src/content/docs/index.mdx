...
tc lets you define serverless apps as graphs of relationships instead of lists of resources. You describe what connects to what, and tc generates all the infrastructure automatically. You can test any part in isolation, run unlimited parallel sandboxes, and your architecture diagram IS your code.

*tc turns architecture diagrams into deployed serverless apps—your topology definition IS your infrastructure.*
