...
From the entity [definitions](/introduction/concepts#entity-abstraction), we know that the _Mutation_ entity has a unique characteric of having abstract types and subscriptions to it's change.
