...
The kneejerk reaction, as developers, is to draw an architecture diagram (or ask ChatGPT you say?) with a zoo AWS services. With functors, we start with datastructures.
