...
The condition keywords `matches` and `includes` semantically compare the response and expected values, there may be a need to have more sophisticated path mapping, transformation and filtering. tc used JsonPath to specify these conditions.
