...
tc treats serverless apps as versioned, namespaced, composable graphs where infrastructure is derived rather than declared. You describe what your app does (routes, functions, events, queues, channels) in a simple YAML file
