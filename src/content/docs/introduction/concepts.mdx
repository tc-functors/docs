...
Lisp, the programming language created by John McCarthy in 1958, has just seven primitives (car, cdr, cons, eq, atom, cond and lambda). All computation can be expressed using these primitives. Such an elegant idea!

What if we can express the entities of a distributed serverless computing system as a topology or graph of computation using similar primitives ?
